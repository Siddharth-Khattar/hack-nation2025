 ...
 *
 * @param panelId - Unique identifier for the panel (e.g., "node-info", "hot-trades")
...
export function usePanelState(
  ...
  const storageKey = `graph-panel-${panelId}`;
  ...
  // This effect intentionally calls setState to sync with localStorage after SSR
  useEffect(() => {
